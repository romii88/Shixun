...
import com.ak.shixun.server.request.AddGroupMemberRequest;
import com.ak.shixun.server.request.AddToBlackListRequest;
import com.ak.shixun.server.request.AgreeFriendsRequest;
import com.ak.shixun.server.request.ChangePasswordRequest;
import com.ak.shixun.server.request.CheckPhoneRequest;
import com.ak.shixun.server.request.CreateGroupRequest;
import com.ak.shixun.server.request.DeleteFriendRequest;
import com.ak.shixun.server.request.DeleteGroupMemberRequest;
import com.ak.shixun.server.request.DismissGroupRequest;
import com.ak.shixun.server.request.FriendInvitationRequest;
import com.ak.shixun.server.request.JoinGroupRequest;
import com.ak.shixun.server.request.LoginRequest;
import com.ak.shixun.server.request.QuitGroupRequest;
import com.ak.shixun.server.request.RegisterRequest;
import com.ak.shixun.server.request.RemoveFromBlacklistRequest;
import com.ak.shixun.server.request.RestPasswordRequest;
import com.ak.shixun.server.request.SendCodeRequest;
import com.ak.shixun.server.request.SetFriendDisplayNameRequest;
import com.ak.shixun.server.request.SetGroupDisplayNameRequest;
import com.ak.shixun.server.request.SetGroupNameRequest;
import com.ak.shixun.server.request.SetGroupPortraitRequest;
import com.ak.shixun.server.request.SetNameRequest;
import com.ak.shixun.server.request.SetPortraitRequest;
import com.ak.shixun.server.request.VerifyCodeRequest;
import com.ak.shixun.server.response.AddGroupMemberResponse;
import com.ak.shixun.server.response.AddToBlackListResponse;
import com.ak.shixun.server.response.AgreeFriendsResponse;
import com.ak.shixun.server.response.ChangePasswordResponse;
import com.ak.shixun.server.response.CheckPhoneResponse;
import com.ak.shixun.server.response.CreateGroupResponse;
import com.ak.shixun.server.response.DefaultConversationResponse;
import com.ak.shixun.server.response.DeleteFriendResponse;
import com.ak.shixun.server.response.DeleteGroupMemberResponse;
import com.ak.shixun.server.response.DismissGroupResponse;
import com.ak.shixun.server.response.FriendInvitationResponse;
import com.ak.shixun.server.response.GetBlackListResponse;
import com.ak.shixun.server.response.GetFriendInfoByIDResponse;
import com.ak.shixun.server.response.GetGroupInfoResponse;
import com.ak.shixun.server.response.GetGroupMemberResponse;
import com.ak.shixun.server.response.GetGroupResponse;
import com.ak.shixun.server.response.GetTokenResponse;
import com.ak.shixun.server.response.GetUserInfoByIdResponse;
import com.ak.shixun.server.response.GetUserInfoByPhoneResponse;
import com.ak.shixun.server.response.GetUserInfosResponse;
import com.ak.shixun.server.response.JoinGroupResponse;
import com.ak.shixun.server.response.LoginResponse;
import com.ak.shixun.server.response.QiNiuTokenResponse;
import com.ak.shixun.server.response.QuitGroupResponse;
import com.ak.shixun.server.response.RegisterResponse;
import com.ak.shixun.server.response.RemoveFromBlackListResponse;
import com.ak.shixun.server.response.RestPasswordResponse;
import com.ak.shixun.server.response.SendCodeResponse;
import com.ak.shixun.server.response.SetFriendDisplayNameResponse;
import com.ak.shixun.server.response.SetGroupDisplayNameResponse;
import com.ak.shixun.server.response.SetGroupNameResponse;
import com.ak.shixun.server.response.SetGroupPortraitResponse;
import com.ak.shixun.server.response.SetNameResponse;
import com.ak.shixun.server.response.SetPortraitResponse;
import com.ak.shixun.server.response.SyncTotalDataResponse;
import com.ak.shixun.server.response.UserRelationshipResponse;
import com.ak.shixun.server.response.VerifyCodeResponse;
import com.ak.shixun.server.response.VersionResponse;
import com.ak.shixun.server.utils.NLog;
import com.ak.shixun.server.utils.json.JsonMananger;
