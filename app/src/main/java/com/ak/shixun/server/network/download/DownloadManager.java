...
package com.ak.shixun.server.network.download;
...
import com.ak.shixun.server.network.http.AsyncHttpClient;
import com.ak.shixun.server.network.http.AsyncHttpResponseHandler;
import com.ak.shixun.server.network.http.BreakpointHttpResponseHandler;
