...
public class WordsEditText extends EditText{
    ...
    public WordsEditText(Context context) {
        this(context,null);
    }
    public WordsEditText(Context context, AttributeSet attrs) {
        super(context,attrs);
        edit = this;
        //设置最多输入的字数
